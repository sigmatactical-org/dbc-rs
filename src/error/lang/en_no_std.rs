...
// The *_TOO_MANY texts are generated by build.rs so they always report the
// configured build-time limit (DBC_MAX_* env vars), not a stale number.
pub const NODES_DUPLICATE_NAME: &str = "Duplicate node name";
pub const NODES_TOO_MANY: &str = crate::LIMIT_MSG_NODES_TOO_MANY;
pub const MESSAGES_TOO_MANY: &str = crate::LIMIT_MSG_MESSAGES_TOO_MANY;
...
pub const MESSAGE_TOO_MANY_SIGNALS: &str = crate::LIMIT_MSG_MESSAGE_TOO_MANY_SIGNALS;
pub const SIGNAL_RECEIVERS_TOO_MANY: &str = crate::LIMIT_MSG_SIGNAL_RECEIVERS_TOO_MANY;
pub const EXTENDED_MULTIPLEXING_TOO_MANY: &str = crate::LIMIT_MSG_EXTENDED_MULTIPLEXING_TOO_MANY;
...
pub const VALUE_DESCRIPTIONS_TOO_MANY: &str = crate::LIMIT_MSG_VALUE_DESCRIPTIONS_TOO_MANY;
...
pub const ATTRIBUTE_DEFINITIONS_TOO_MANY: &str = crate::LIMIT_MSG_ATTRIBUTE_DEFINITIONS_TOO_MANY;
pub const ATTRIBUTE_VALUES_TOO_MANY: &str = crate::LIMIT_MSG_ATTRIBUTE_VALUES_TOO_MANY;
pub const ATTRIBUTE_ENUM_VALUES_TOO_MANY: &str = crate::LIMIT_MSG_ATTRIBUTE_ENUM_VALUES_TOO_MANY;
